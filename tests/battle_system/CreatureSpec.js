...
describe("Creature", function() {
 ...
 it("should have all attributes by default set to 0 even if not provided in constructor",function(){
     var d = new Creature({'abilities':{},'crafts':{},'m_amount':100, 'side':'D'});
 ...
 it("should allow setting all abilities from config file",function(){
     ...
     var d1 = new Creature( {'abilities':t,'crafts':{},'m_amount':100, 'side':'D'} );
 ...
 it("should allow setting all crafts from config file",function(){
  ...
  it("should allow setting crafts bonus roll on Creature creation",function(){
    ...
    var d = new Creature( {'abilities':{},'crafts':{'swim':+2},'m_amount':100, 'side':'D'} );
   ...
   it("shouldn't allow setting properties with random names",function(){
    ...
    expect(function(){
        var d = new Creature({ 'abilities':{'some_random_ability_name':10}, 'crafts':{},'m_amount':100,'side':'D' });
